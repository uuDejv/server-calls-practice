...
const Errors = require("../api/errors/example-main-error.js");
...
const logger = LoggerFactory.get("ExampleMainAbl");

class ExampleMainAbl {
  constructor() {
...
module.exports = new ExampleMainAbl();
